...
def make_web_client(db):
    ...
    Client alongside their Membership — handy for building two clients
    scoped to two different salons in cross-tenant tests, or for downgrading
    the membership's role to test permission checks."""
